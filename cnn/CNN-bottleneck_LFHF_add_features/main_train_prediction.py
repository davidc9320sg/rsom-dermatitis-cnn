...
if __name__ == '__main__':
    ...
    for cv in [5]:
        ...
        if checkpoint_epoch is not None:
             checkpoint_dir = 'results/healthy_v_eczema/CV{}/{}/model/my_model.ckpt-{}'.format(cv, experiment_type, checkpoint_epoch)
        ...
        with tf.Session() as sess:
            if checkpoint_dir is not None:
                ...
                start_epoch, end_epoch = checkpoint_epoch, checkpoint_epoch + EPOCHS
            else:
            ...
            for epoch in range(start_epoch, end_epoch):
                ...
                if epoch % 1 == 0:
                    with open(output_folder + '/loss_curve.txt', 'a') as fp:
                        fp.write(text)
                    fp.close()
